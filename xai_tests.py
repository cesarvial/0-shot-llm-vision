...
Usage example:
  python xai_neighbors_gradcam_with_text.py --embed_file data/coco_resnet50_val2017_img.pt --text_emb_file data/coco_allroberta_val2017_text.pt --coco_root ./coco_dataset --split val2017 --n_queries 5 --topk 5 --top_text_k 5
...
def main():
    ...
    if not os.path.isfile(args.embed_file):
        alt = args.embed_file.replace('_img.pt', '_val2017_img.pt')
